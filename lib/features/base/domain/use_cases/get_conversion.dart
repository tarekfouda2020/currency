...
class GetConversion implements UseCase<String, HistoricalParams> {
  @override
  Future<String> call(HistoricalParams params) async {
    var data = await getIt<BaseRepository>().convert(params);
